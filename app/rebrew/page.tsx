        ...
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="border border-ink/20 p-8">
              ...
              <p className="text-ink/80">Exploring bio-material storytelling that bridges speculative technology and embodied care.</p>
            </div>
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Format</span>
              <h3 className="text-xl font-display font-semibold mb-3">Rehydratable wetware sheets</h3>
              <p className="text-ink/80">Infused papers that steep into tea, broth, steam, or poultice-based remedies.</p>
            </div>
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Practice</span>
              <h3 className="text-xl font-display font-semibold mb-3">Ethnography · Bio-material prototyping</h3>
              <p className="text-ink/80">Grounded in interviews around domestic wellness rituals and iterative material trials.</p>
            </div>
          </div>

          <div className="flex flex-wrap gap-3">
            <span className="px-4 py-2 border border-ink/20 text-ink/80 text-sm uppercase tracking-wider">Dissolvable paper</span>
            <span className="px-4 py-2 border border-ink/20 text-ink/80 text-sm uppercase tracking-wider">Traditional herbalism</span>
            <span className="px-4 py-2 border border-ink/20 text-ink/80 text-sm uppercase tracking-wider">Zero-waste system</span>
            <span className="px-4 py-2 border border-ink/20 text-ink/80 text-sm uppercase tracking-wider">Biodegradable materials</span>
          </div>
          ...
          <section>
            ...
            <ul className="space-y-3 text-ink/80">
              <li><strong className="text-ink">San Francisco Design Week 2024, Best Student Design</strong></li>
            </ul>
          </section>
