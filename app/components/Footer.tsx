...
export default function Footer() {
  return (
    <footer className="border-t border-brown-200/10 py-16 px-16 opacity-85">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 items-center text-sm">
        <div className="text-bone/80 text-center md:text-left">
          © 2025 María-Teresa Carmier
        </div>

        <div className="text-bone/60 uppercase tracking-wider text-xs text-center font-body">
          <span>AI Safety</span> · <span>Digital Infrastructure</span> · <span>Public-Interest Technology</span>
        </div>

        <div className="flex gap-6 justify-center md:justify-end text-bone/80">
          <a
