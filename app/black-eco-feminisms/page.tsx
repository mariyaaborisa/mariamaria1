        ...
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Focus</span>
              <h3 className="text-xl font-display font-semibold mb-3">Environmental Justice · Urban Planning</h3>
              <p className="text-ink/80">Community-centered civic design addressing land use, displacement, and ecological care.</p>
            </div>
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Role</span>
              <h3 className="text-xl font-display font-semibold mb-3">Urban Planning Intern</h3>
              <p className="text-ink/80">Designed listening sessions and co-creation workshops with Oakland residents and organizers.</p>
            </div>
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Methods</span>
              <h3 className="text-xl font-display font-semibold mb-3">Systems Mapping · Co-design · Storytelling</h3>
              <p className="text-ink/80">Translating lived experiences into civic intelligence and design artifacts.</p>
            </div>
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Publication</span>
              <h3 className="text-xl font-display font-semibold mb-3">Routledge Chapter (Forthcoming)</h3>
              <p className="text-ink/80">Contributing to "Indigenous Sovereignty in Environmental Research" on land stewardship.</p>
            </div>
          </div>
          ...
          <section>
            ...
            <ul className="space-y-3 text-ink/80">
              <li><strong className="text-ink">Listening sessions:</strong> Centered intergenerational narratives around environmental impact, community healing, and land stewardship</li>
              <li><strong className="text-ink">Civic design strategy:</strong> Mapped relationships between community assets, governance, and environmental inequities</li>
              <li><strong className="text-ink">Workshop design:</strong> Merged art, policy dialogue, and activism to translate stories into action</li>
              <li><strong className="text-ink">Training & tools:</strong> Produced volunteer materials, facilitation guides, and visual systems maps</li>
            </ul>
          </section>
