    ...
    <main className="min-h-screen pt-32 pb-24 px-8 md:px-16">
      <div className="container mx-auto max-w-6xl">
        ...
        <header className="mb-16">
          ...
          <p className="text-lg md:text-xl text-brown-100 mb-8 max-w-4xl">
          ...
          <div className="flex flex-wrap gap-4">
            <Link
              href="/about"
              className="px-6 py-3 bg-accent-surface text-bone transition-all duration-300 hover:bg-accent hover:text-brown-600 font-body uppercase tracking-wider text-sm font-medium"
            >
              View resume
            </Link>
            <a
              ...
              className="px-6 py-3 border border-brown-200/10 text-brown-100 transition-all duration-300 hover:border-accent hover:text-accent font-body uppercase tracking-wider text-sm font-medium"
            >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project) => (
              <Link
                key={project.id}
                href={project.href}
                className="group border border-brown-200/10 p-8 transition-all duration-300 hover:border-accent hover:translate-y-[-4px]"
              >
                <span className="text-xs uppercase tracking-widest font-body text-brown-200 block mb-4">
                  {project.tag}
                </span>
                <h3 className="text-2xl font-display font-semibold tracking-tight mb-3 transition-colors duration-300 group-hover:text-accent">
                  {project.title}
                </h3>
