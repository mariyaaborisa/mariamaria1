        ...
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="border border-ink/20 p-8">
              ...
              <p className="text-ink/80">Blending responsible machine learning with immersive interpretation inside museum and classroom settings.</p>
            </div>
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Experience</span>
              <h3 className="text-xl font-display font-semibold mb-3">Interactive avatar installation</h3>
              <p className="text-ink/80">Conversation-led encounters where visitors pose questions directly to a resurrected Horton.</p>
            </div>
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Stack</span>
              <h3 className="text-xl font-display font-semibold mb-3">Speech-to-Text · GPT · AWS Polly · D-ID API</h3>
              <p className="text-ink/80">Combining language models with voice and facial synthesis for responsive dialogue.</p>
            </div>
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Setting</span>
              <h3 className="text-xl font-display font-semibold mb-3">Case study in responsible AI</h3>
              <p className="text-ink/80">Designed to interrogate ethics, authorship, and empathy within cultural heritage technologies.</p>
            </div>
          </div>
          ...
          <section>
            ...
            <ul className="space-y-3 text-ink/80">
              <li><strong className="text-ink">Speech-to-Text + GPT:</strong> Historically grounded conversational responses</li>
              <li><strong className="text-ink">AWS Polly + D-ID API:</strong> Lifelike voice and facial synthesis</li>
              <li><strong className="text-ink">Gradio interface:</strong> Accessible museum/classroom interaction</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-ink/80 leading-relaxed">
              <p>
                <strong className="text-ink">Research & ethical framework:</strong> Analyzed Horton's complete corpus and established guidelines for responsible AI representation—transparency about AI generation, no speculation beyond documented history.
              </p>
              <p>
                <strong className="text-ink">Technical development:</strong> Integrated speech-to-text, GPT, and avatar synthesis to create responsive, historically grounded dialogue.
              </p>
              <p>
                <strong className="text-ink">Key question:</strong> Who has the right to resurrect suppressed voices? This project confronts fundamental questions of consent, cultural sovereignty, and technological power—demonstrating how AI can serve historical memory and human dignity rather than extraction and exploitation.
              </p>
            </div>
          </section>
