        ...
        <div className="space-y-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="border border-ink/20 p-8">
              ...
              <p className="text-ink/80">Merging storytelling, writing, and electronics to create hybrid learning experiences.</p>
            </div>
            <div className="border border-ink/20 p-8">
              ...
              <p className="text-ink/80">Hands-on exploration that encourages learners to orient themselves through story and sky.</p>
            </div>
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Toolkit</span>
              <h3 className="text-xl font-display font-semibold mb-3">Arduino · Magnetometer · LCD</h3>
              <p className="text-ink/80">Modular electronics coupled with narrative prompts for classroom tinkering.</p>
            </div>
            <div className="border border-ink/20 p-8">
              <span className="text-xs uppercase tracking-widest font-body text-ink/70 block mb-4">Curriculum</span>
              <h3 className="text-xl font-display font-semibold mb-3">Co-designed lesson plans</h3>
              <p className="text-ink/80">Tested with K–5 learners to strengthen spatial reasoning and creative writing.</p>
            </div>
          </div>
          ...
          <section>
            ...
            <p className="text-ink/80 leading-relaxed mb-4">
              <strong className="text-ink">Participants:</strong> 50 students (Grades 3–5) and 5 teachers in mixed-language classrooms.
            </p>
            <p className="text-ink/80 leading-relaxed mb-4">
              <strong className="text-ink">Methods:</strong> Observation, think-alouds, student journaling, and teacher reflection logs.
            </p>
            <ul className="space-y-3 text-ink/80 mb-6">
            ...
            <p className="text-ink/80 leading-relaxed">
              <strong className="text-ink">Design implication:</strong> Curriculum should make uncertainty visible and playable.
            </p>
          </section>
